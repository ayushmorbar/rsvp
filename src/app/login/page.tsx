...
export const metadata: Metadata = {
  title: "Login | RSVP by Offbeats",
  description: "Sign in to your RSVP account to discover and manage campus events.",
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Sign in to discover amazing campus events</p>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-500">
            🎓 Free forever for students with verified .edu email addresses
          </p>
        </div>
      </div>
    </div>
